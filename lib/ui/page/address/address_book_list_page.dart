...
class AddressBookListPage extends StatefulWidget {
   int? type;
  AddressBookListPage({Key? key,this.type=AddressBookListType.edit}) : super(key: key);

  @override
  State<AddressBookListPage> createState() => _AddressBookListPageState();
}

class _AddressBookListPageState extends State<AddressBookListPage> {
                     ...
                     return Material(
                       ...
                       child: InkWell(
                         onTap: (){
                           ...
                           if(widget.type==AddressBookListType.edit){
