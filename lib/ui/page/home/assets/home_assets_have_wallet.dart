...
class HomeAssetsHaveWallet extends StatefulWidget {


   HomeAssetsHaveWallet({Key? key}) : super(key: key);

  @override
  State<HomeAssetsHaveWallet> createState() => _HomeAssetsHaveWalletState();
}

class _HomeAssetsHaveWalletState extends State<HomeAssetsHaveWallet> {
