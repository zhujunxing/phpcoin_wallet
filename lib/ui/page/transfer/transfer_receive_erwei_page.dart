...
class TransferReceiveErWeiPage extends StatefulWidget {
   String address;

  TransferReceiveErWeiPage({Key? key,required this.address}) : super(key: key);

  @override
  State<TransferReceiveErWeiPage> createState() => _TransferReceiveErWeiPageState();
}

class _TransferReceiveErWeiPageState extends State<TransferReceiveErWeiPage> {
  late TransferReceiveErWeiController controller;

  @override
  Widget build(BuildContext context) {
    controller=Get.put(TransferReceiveErWeiController(widget.address));
