...
class WalletCreateImportPage extends StatefulWidget {
  WalletCreateImportData data;
  WalletCreateImportPage(this.data,{Key? key}) : super(key: key);

  @override
  State<WalletCreateImportPage> createState() => _WalletCreateImportPageState();
}

class _WalletCreateImportPageState extends State<WalletCreateImportPage> {
  late WalletCreateImportController controller;
  @override
  void initState() {
    super.initState();
    controller=Get.put(WalletCreateImportController(widget.data));
  }
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        appBar:BaseAppBar(
          title:widget.data.walletSelectType==WalletSelectType.create?Ids.createWallet.tr:Ids.importWallet.tr,
        ),
