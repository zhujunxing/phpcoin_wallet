...
class WalletManagerItemPage extends StatefulWidget {
    int? clickType;
  WalletManagerItemPage({Key? key,this.clickType=WalletManagerClickType.detail}) : super(key: key);

  @override
  State<WalletManagerItemPage> createState() => _WalletManagerItemPageState();
}

class _WalletManagerItemPageState extends State<WalletManagerItemPage> {
    ...
    return Obx((){
      return Row(
        children: [
          ...
          callback: (wallet){
             if(wallet!=null){
                if(widget.clickType==WalletManagerClickType.detail){
