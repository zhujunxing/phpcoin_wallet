...
class WalletPrivateImportPage extends StatefulWidget {
  WalletCreateImportData data;
  WalletPrivateImportPage(this.data,{Key? key}) : super(key: key);

  @override
  State<WalletPrivateImportPage> createState() => _WalletPrivateImportPageState();
}

class _WalletPrivateImportPageState extends State<WalletPrivateImportPage> {
  late WalletPrivateImportController controller;
  @override
  void initState() {
    super.initState();
    controller=Get.put(WalletPrivateImportController(widget.data));
  }
  @override
