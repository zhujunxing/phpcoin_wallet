...
class WalletWatchImportPage extends StatefulWidget {
  WalletCreateImportData data;
  WalletWatchImportPage(this.data,{Key? key}) : super(key: key);

  @override
  State<WalletWatchImportPage> createState() => _WalletWatchImportPageState();
}

class _WalletWatchImportPageState extends State<WalletWatchImportPage> {
  late WalletWatchImportController controller;
   @override
  void initState() {
    super.initState();
    controller=Get.put(WalletWatchImportController(widget.data));
   }
  @override
