...
class WalletPwdModifyPage extends StatefulWidget {
  String address;
  WalletPwdModifyPage(this.address,{Key? key}) : super(key: key);

  @override
  State<WalletPwdModifyPage> createState() => _WalletPwdModifyPageState();
}

class _WalletPwdModifyPageState extends State<WalletPwdModifyPage> {
  late WalletPwdModifyController controller;
  @override
  void initState() {
    super.initState();
    controller=Get.put(WalletPwdModifyController(widget.address));
  }
  @override
