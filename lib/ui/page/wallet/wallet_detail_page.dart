...
class _WalletDetailPageState extends State<WalletDetailPage> {
  ...
  void initState() {
    super.initState();
    controller=Get.put(WalletDetailController(widget.wallet));
   }
  @override
                ...
                slivers: [
                  ...
                  SliverToBoxAdapter(
                    child: _buildItem(Ids.modifyPwd.tr,click: (){
                      Get.toNamed(Routes.walletPwdModify,arguments: widget.wallet.walletAddress);
                    }),
                  ),
                  SliverToBoxAdapter(
                    child: _buildItem(Ids.resetPwd.tr,click: (){
                      Get.toNamed(Routes.walletPwdPrivateKeyModify,arguments: widget.wallet.walletAddress);
                    },isVisible: false),
                  ),
                ],
              )),
