...
class WalletPwdPrivateKeyModifyPage extends StatefulWidget {
  String address;
  WalletPwdPrivateKeyModifyPage(this.address,{Key? key}) : super(key: key);

  @override
  State<WalletPwdPrivateKeyModifyPage> createState() => _WalletPwdPrivateKeyModifyPageState();
}

class _WalletPwdPrivateKeyModifyPageState extends State<WalletPwdPrivateKeyModifyPage> {
  late WalletPwdPrivateKeyModifyController controller;
  @override
  void initState() {

    super.initState();
    controller=Get.put(WalletPwdPrivateKeyModifyController(widget.address));
  }
  @override
