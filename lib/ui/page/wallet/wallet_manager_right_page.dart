...
class WalletManagerRightPage extends StatefulWidget {
  final WalletTypeBean data;
  Function? callback;
   WalletManagerRightPage(this.data,{Key? key,this.callback}) : super(key: key);

  @override
  State<WalletManagerRightPage> createState() => _WalletManagerRightPageState();
}

class _WalletManagerRightPageState extends State<WalletManagerRightPage> {
  ...
  void initState() {
    super.initState();
    controller=Get.put(WalletManagerRightController(widget.data));
        ...
        slivers: [
          SliverToBoxAdapter(
            child: Container(
              ...
              child: Row(
                children: [
                  Text(widget.data.walletType,style: TextStyle(
                ...
                child: GestureDetector(
                  ...
                  onTap: (){
                    if(widget.callback!=null){
                      widget.callback!.call(controller.walletAr.toList().elementAt(index));
                    }
                  },
                ),
