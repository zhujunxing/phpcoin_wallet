        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child:Container(
              ...
              margin: EdgeInsets.fromLTRB(Dimens.dp15, 0, Dimens.dp15,0),
              padding: EdgeInsets.all(Dimens.dp15),
              child: Text("${widget.data.privateKey}",style: TextStyle(
                fontSize: Dimens.sp14,
              ...
              child: Row(
                ...
                children: [
                  CustomButton(Ids.copyPrivate.tr,
                    width: Dimens.dp220,
                    onPressed: (){
                      Clipboard.setData(ClipboardData(text:'${widget.data.privateKey}'));
                      ToastUtil.toast(context, "${widget.data.privateKey}${Ids.alreadyCopy.tr}");
                    },
                  )
                ],
              ),
