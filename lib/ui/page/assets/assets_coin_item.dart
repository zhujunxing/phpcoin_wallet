...
class AssetsCoinItem extends StatefulWidget {
  final AssetsCoinData item;
 final int position;
  const AssetsCoinItem(this.item,this.position,{Key? key}) : super(key: key);

  @override
  State<AssetsCoinItem> createState() => _AssetsCoinItemState();
}

class _AssetsCoinItemState extends State<AssetsCoinItem> {
  @override
                  ...
                  child: Row(
                    children: [
                      Container(
                        ...
                        child: Image.asset(widget.item.icon,width: Dimens.dp38,height: Dimens.dp38,),
                      ...
                      Gaps.wGap10,
                      Text(widget.item.tokenName,style: TextStyles.largeText,),
                    ],
                  ),
                ),
                Align(
                  ...
                  child:Container(
                    ...
                    child: Column(
                      ...
                      mainAxisSize: MainAxisSize.min,
                      children: [
                        Text(widget.item.balance,style: TextStyle(
                          fontSize: Dimens.sp18,
                          color:Colours.defaultTextColor,
                        ),),
                        Gaps.hGap2,
                        Text("≈ \$${widget.item.money}",style: TextStyle(
