...
class ImageScreenShowPage extends StatelessWidget {

 final ImageScreenData data;
 late ImageScreenShowController controller=ImageScreenShowController(data);
 final GlobalKey<ExtendedImageSlidePageState> slidePageKey =
 GlobalKey<ExtendedImageSlidePageState>();
   ImageScreenShowPage(this.data,{Key? key}) : super(key: key);
 ...
 @override
  Widget build(BuildContext context) {
   controller=ImageScreenShowController(data);
   ...
   if(isPermission){
     if(UrlUtil.isNetUrl(url)){
       ...
       if (imageId!=null&&imageId!='') {
         ...
         var saveFile =await ImageGallerySaver.saveFile(path!);
         ...
         ToastUtil.toast(context,"${Ids.download.tr}${Ids.image.tr}${Ids.failure.tr}");
       }
     }else{
